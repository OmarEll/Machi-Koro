...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget->setGeometry(QRect(430, 570, 221, 61));
        ...
        expansions_cb = new QComboBox(widget);
        ...
        widget1->setGeometry(QRect(10, 80, 211, 101));
        ...
        new_btn = new QPushButton(widget1);
